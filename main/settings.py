...
env = environ.Env(
    ...
    ALLOWED_REDIRECT_URLS=(list, ["http://localhost:3000"]),
    BREVO_API_KEY=str,
)
...
MIDDLEWARE = [
    ...
    # "apps.business.csrf_middleware.CSRFExemptMiddleware",
...
# CSRF Configuration for API requests from frontend origins
...
# Serialize tasks using JSON (safe with any data type)
...
CELERY_TASK_SOFT_TIME_LIMIT = 5 * 60  # 5 minutes soft limit
